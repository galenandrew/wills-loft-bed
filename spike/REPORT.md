...
[build] 38 solids in 0.03s (12 derived, not yaml members)
...
[section] cut+HLR in 0.49s → spike/d4-kernel.svg, spike/d8b-kernel.svg
          worst cut-edge deviation vs d4.svg: 0.0043" on stringer_b (1/16" = 0.0625)
[export] model.step/.stl (Z-up, CAD) + model-yup.step/.stl (Y-up, previewers) in 0.27s
         re-imported: 38 solids (wrote 38), volume 10820.74 vs 10820.74 cu in, Δ 0.0000

TOTAL 1.17s  (build 0.03 · clash 0.29 · fasteners 0.01 · section 0.49 · export 0.27)
```
