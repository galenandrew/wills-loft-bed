...
[clash] 0 real interferences, 4 coincident faces (0.30s) → spike/clash.txt
...
[export] model.step 776 kB, model.stl 30 kB in 0.13s
         re-imported: 38 solids (wrote 38), volume 10820.74 vs 10820.74 cu in, Δ 0.0000

TOTAL 0.91s  (build 0.05 · clash 0.30 · fasteners 0.01 · section 0.34 · export 0.13)
```
