...
[section] cut+HLR in 0.33s → spike/d4-kernel.svg, spike/d8b-kernel.svg
          worst cut-edge deviation vs d4.svg: 0.0043" on stringer_b (1/16" = 0.0625)
[export] model.step 776 kB, model.stl 30 kB in 0.14s
         re-imported: 38 solids (wrote 38), volume 10820.74 vs 10820.74 cu in, Δ 0.0000

TOTAL 0.88s  (build 0.03 · clash 0.28 · fasteners 0.01 · section 0.33 · export 0.14)
```
