...
dimensions.yaml rev AD · stair: 6 risers @ 8.2500 + 8.5000, run 9.0, throat 5.168

[build] 113 solids in 0.14s (12 derived, not yaml members)
        loft        28 solids     7.60 cu ft
        screen      24 solids     1.27 cu ft
        stair       26 solids     3.61 cu ft
        half_wall   19 solids     3.29 cu ft
        nook        12 solids     1.90 cu ft
        ...
        hw_sheath_stair_a is ONE notched solid (255.937 cu in, x 106.25→107); yaml rows fused: hw_sheath_stair_a_head, ledge_end_cap
        hw_sheath_stair_head is ONE notched solid (914.072 cu in, x 106.25→107); yaml rows fused: hw_sheath_stair_b, beam_end_cap
...
[export] model.step 2038 kB, model.stl 75 kB in 0.42s
         re-imported: 109 solids (wrote 109), volume 30526.93 vs 30526.93 cu in, Δ 0.0000

TOTAL 2.72s  (build 0.14 · clash 0.64 · fasteners 0.03 · section 0.84 · export 0.42)
```
