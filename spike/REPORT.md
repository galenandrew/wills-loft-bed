...
dimensions.yaml rev AE · stair: 6 risers @ 8.2500 + 8.5000, run 9.0, throat 5.168

[build] 111 solids in 0.11s (12 derived, not yaml members)
...
[loft] bearing areas, slat gaps and clearances in 0.43s → spike/loft.txt
...
[export] model.step 2028 kB, model.stl 75 kB in 0.41s
         re-imported: 107 solids (wrote 107), volume 30107.50 vs 30107.50 cu in, Δ 0.0000

TOTAL 2.67s  (build 0.11 · clash 0.64 · fasteners 0.02 · section 0.84 · export 0.41)
```
