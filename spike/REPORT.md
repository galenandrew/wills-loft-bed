...
dimensions.yaml rev AQ · stair: 6 risers @ 8.2500 + 8.5000, run 9.0, throat 5.168

[build] 108 solids in 0.17s (12 derived, not yaml members)
...
[clash] 0 real interferences, 3 coincident faces (0.66s) → spike/clash.txt
        underside ray cast vs Stair.underside(): worst Δ 0.00000"
[loft] bearing areas, slat gaps and clearances in 0.30s → spike/loft.txt
...
[section] cut+HLR in 0.85s → spike/d4-kernel.svg, spike/d8b-kernel.svg
          worst cut-edge deviation vs d4.svg: 0.0048" on stringer_b (1/16" = 0.0625)
[export] model.step 1978 kB, model.stl 74 kB in 0.43s
         re-imported: 104 solids (wrote 104), volume 34430.38 vs 34430.38 cu in, Δ 0.0000

TOTAL 2.62s  (build 0.17 · clash 0.66 · fasteners 0.03 · section 0.85 · export 0.43)
```
