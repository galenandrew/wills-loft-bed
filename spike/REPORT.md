...
dimensions.yaml rev AH · stair: 6 risers @ 8.2500 + 8.5000, run 9.0, throat 5.168

[build] 111 solids in 0.16s (12 derived, not yaml members)
        loft        28 solids     8.18 cu ft
        screen      24 solids     1.10 cu ft
        stair       26 solids     3.67 cu ft
        half_wall   18 solids     3.15 cu ft
        nook        11 solids     1.75 cu ft
        context      4 solids    56.33 cu ft
        ...
        hw_sheath_stair is ONE notched solid (692.531 cu in, x 106.25→107); yaml rows fused: ledge_end_cap, beam_end_cap
        hw_end_cap is ONE notched solid (171.750 cu in, x 102→107); yaml rows fused: hw_end_cap_foot
[clash] 0 real interferences, 3 coincident faces (0.73s) → spike/clash.txt
        underside ray cast vs Stair.underside(): worst Δ 0.00000"
[loft] bearing areas, slat gaps and clearances in 0.35s → spike/loft.txt
...
[section] cut+HLR in 0.96s → spike/d4-kernel.svg, spike/d8b-kernel.svg
          worst cut-edge deviation vs d4.svg: 0.0048" on stringer_b (1/16" = 0.0625)
[export] model.step 2028 kB, model.stl 75 kB in 0.48s
         re-imported: 107 solids (wrote 107), volume 30840.03 vs 30840.03 cu in, Δ 0.0000

TOTAL 2.94s  (build 0.16 · clash 0.73 · fasteners 0.03 · section 0.96 · export 0.48)
```
