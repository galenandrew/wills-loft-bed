...
1. **Missing declarations.** Read the drawings and text. List every connection they claim or imply. Any that is not in the `connections:` block of the yaml is unverified and is a finding — say which members and what the drawing claims.
